...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{01}: Adicionar Dinheiro 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{02}: Adicionar Moedas 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{03}: Inserir Rank King 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{04}: Mudar ID 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{05}: Mudar Nome 0.000k'))
            print(Colorate.Horizontal(Colors.rainbow, '{06}: Mudar Nome (Rainbow) 0.000k'))
            print(Colorate.Horizontal(Colors.rainbow, '{07}: Placas de Número 0.000K'))
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{10}: Deletar Amigos 0.00'))
            print(Colorate.Horizontal(Colors.rainbow, '{11}: Desbloquear Carros Pagos 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{12}: Desbloquear Todos os Carros 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{13}: Desbloquear Sirene Em Todos os Carros 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{14}: Desbloquear Motor w16 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{15}: Desbloquear Todas as Buzinas 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{16}: Desbloquear Desabilitar Dano 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{17}: Desbloquear Combustível Ilimitado 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{18}: Desbloquear Casa 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{19}: Desbloquear Fumaça 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{20}: Desbloquear Rodas 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{21}: Desbloquear Animações 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{22}: Desbloquear Equipamentos M 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{23}: Desbloquear Equipamentos F 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{24}: Mudar Vitórias em Corridas 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{25}: Mudar Derrotas em Corridas 0.000K'))
            print(Colorate.Horizontal(Colors.rainbow, '{26}: Clonar Conta 0.000K'))
