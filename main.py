...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{01}: Adicionar Dinheiro GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{02}: Adicionar Moedas GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{03}: Inserir Rank King GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{04}: Mudar ID GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{05}: Mudar Nome GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{06}: Mudar Nome (Rainbow) GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{07}: Placas de Número GRÁTIS'))
            ...
            print(Colorate.Horizontal(Colors.rainbow, '{10}: Deletar Amigos GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{11}: Desbloquear Carros Pagos GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{12}: Desbloquear Todos os Carros GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{13}: Desbloquear Sirene Em Todos os Carros GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{14}: Desbloquear Motor w16 GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{15}: Desbloquear Todas as Buzinas GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{16}: Desbloquear Desabilitar Dano GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{17}: Desbloquear Combustível Ilimitado GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{18}: Desbloquear Casa GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{19}: Desbloquear Fumaça GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{20}: Desbloquear Rodas GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{21}: Desbloquear Animações GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{22}: Desbloquear Equipamentos M GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{23}: Desbloquear Equipamentos F GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{24}: Mudar Vitórias em Corridas GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{25}: Mudar Derrotas em Corridas GRÁTIS'))
            print(Colorate.Horizontal(Colors.rainbow, '{26}: Clonar Conta GRÁTIS'))
